...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* This section will now be full-width by default */}
      <section 
        className="relative flex flex-col items-center justify-center text-center h-[60vh] overflow-hidden"
      >
        <video
          autoPlay
          loop
        ...
        <div className="relative z-20 text-white px-4">
          ...
          <p className="mt-6 text-lg leading-8 max-w-2xl text-slate-300">
            The AI-powered platform that automates user interviews and analysis.
          </p>
          <div className="mt-10">
      ...
      {/* This section now has its own layout constraints */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-muted-foreground">Share a simple link and let our AI agent conduct natural conversations.</p>
            </div>
            <div className="flex flex-col items-center">
